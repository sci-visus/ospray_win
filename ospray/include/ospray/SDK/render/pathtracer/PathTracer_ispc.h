//
// C:/Users/visuser/gitlab-runner/builds/xMnq9aWp/0/sdvis/ospray/build_release/ospray/render/pathtracer/PathTracer_ispc.h
...
#ifndef __ISPC_STRUCT_v4_varying_vkl_vec3f__
#define __ISPC_STRUCT_v4_varying_vkl_vec3f__
__ISPC_ALIGNED_STRUCT__(16) v4_varying_vkl_vec3f {
...
#ifndef __ISPC_STRUCT_vkl_vec3f__
#define __ISPC_STRUCT_vkl_vec3f__
struct vkl_vec3f {
    float x;
    float y;
    float z;
...
#ifndef __ISPC_STRUCT_vkl_box3f__
#define __ISPC_STRUCT_vkl_box3f__
struct vkl_box3f {
    struct vkl_vec3f lower;
    struct vkl_vec3f upper;
};
#endif

#ifndef __ISPC_STRUCT_v4_varying_vkl_range1f__
#define __ISPC_STRUCT_v4_varying_vkl_range1f__
__ISPC_ALIGNED_STRUCT__(16) v4_varying_vkl_range1f {
...
__ISPC_ALIGNED_STRUCT__(16) v4_varying_VKLInterval {
    struct v4_varying_vkl_range1f tRange;
    struct v4_varying_vkl_range1f valueRange;
    __ISPC_ALIGN__(16) float nominalDeltaT[4];
};
#endif

#ifndef __ISPC_STRUCT_vkl_range1f__
#define __ISPC_STRUCT_vkl_range1f__
struct vkl_range1f {
    float lower;
    float upper;
};
...
extern "C" {
#endif // __cplusplus
    extern void *  PathTracer_create(void * cppE);
    extern void PathTracer_destroy(void * _self);
    extern void PathTracer_set(void * _self, const int32_t rouletteDepth, const float maxRadiance, const struct vec4f &shadowCatcherPlane, const int32_t numLightSamples);
    extern void PathTracer_setLights(void * _self, void *  * lights, const uint32_t numLights, const uint32_t numGeoLights);
...
#ifndef __ISPC_STRUCT_v8_varying_vkl_vec3f__
#define __ISPC_STRUCT_v8_varying_vkl_vec3f__
__ISPC_ALIGNED_STRUCT__(32) v8_varying_vkl_vec3f {
...
#ifndef __ISPC_STRUCT_v8_varying_vkl_range1f__
#define __ISPC_STRUCT_v8_varying_vkl_range1f__
__ISPC_ALIGNED_STRUCT__(32) v8_varying_vkl_range1f {
...
__ISPC_ALIGNED_STRUCT__(32) v8_varying_VKLInterval {
    struct v8_varying_vkl_range1f tRange;
    struct v8_varying_vkl_range1f valueRange;
...
#ifndef __ISPC_STRUCT_v16_varying_vkl_vec3f__
#define __ISPC_STRUCT_v16_varying_vkl_vec3f__
__ISPC_ALIGNED_STRUCT__(64) v16_varying_vkl_vec3f {
...
#ifndef __ISPC_STRUCT_v16_varying_vkl_range1f__
#define __ISPC_STRUCT_v16_varying_vkl_range1f__
__ISPC_ALIGNED_STRUCT__(64) v16_varying_vkl_range1f {
...
__ISPC_ALIGNED_STRUCT__(64) v16_varying_VKLInterval {
    struct v16_varying_vkl_range1f tRange;
    struct v16_varying_vkl_range1f valueRange;
